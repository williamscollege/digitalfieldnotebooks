...
class Authoritative_Plant_Extra_AJAX_Test extends WMSWebTestCase {
...
//    }
    ...
    function testToDo() {
        $this->todo('access control checks test');
        $this->todo('invalid data checks test');
        $this->todo('form for new common name test');
        $this->todo('form for new description test');
        $this->todo('common name, descr reorder test');
        $this->todo('common name, descr delete test');
// NOTE: image upload too messy to test at the moment - it works for now, and if it breaks later then we'll add a test for it then
        $this->todo('image re-order test');
        $this->todo('image delete test');

        $this->todo('javascript actions on auth plant page: update hidden ape id arrays on add & delete');
        $this->todo('handle saving of re-ordering a la spec images on notebook pages');
        $this->todo('handle specimens same as on notebook page');
    }
}