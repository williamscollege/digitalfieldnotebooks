...
class PublicPagesAccessTest extends WMSWebTestCase {
    ...
    function testNotebookSpecific() {
        $this->get('http://localhost/digitalfieldnotebooks/app_code/notebook.php?notebook_id=1004');
        $this->doAsserts();
//exit;
    }
...
//        $this->todo();
        $this->get('http://localhost/digitalfieldnotebooks/app_code/notebook_page.php?notebook_page_id=1104');
        $this->doAsserts();
    }
