<?php
    ...
    # viable actions:
    #    - create (type, unique string) : return a form of the approp type
    #    - image_upload : handle the load for a new ape of type image
    #    - delete : remove an ape (maybe not needed...? needed only for images...?)
    #    - reorder : handle reordering for a given type of ape
//
